...
import br.com.fiap.marvelapp.data.MarvelComicDataResultModel
...
class ComicListAdapter : RecyclerView.Adapter<ComicListAdapter.ComicItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ComicListAdapter.ComicItemViewHolder {
    ...
    override fun onBindViewHolder(holder: ComicListAdapter.ComicItemViewHolder, position: Int) {
